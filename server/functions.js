...
module.exports.makeInvoiceId = function makeid(length) {
  var result           = '';
...
module.exports.sendVerify = async function sendWelcome(to,verifyCode){
  let transporter = nodemailer.createTransport({
    host: "d2.my-control-panel.com",
    port: 587,
    secure: false,
                      ...
                      <tbody>
                        ...
                        >
                          <td
                            ...
                            "
                          >
                            Our systems show that you need a code for syncing your data with our panel. Please use the code below before it expires.
                          </td>
                        </tr>
                        <tr
                          style="
