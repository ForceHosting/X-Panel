  ...
  <div class="py-12">
    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <div>
            <p class="my-2 text-center text-xs font-extrabold text-gray-900">By logging in you agree with our <a href="" class="text-blue-500">Terms Of Service</a> and <a href="" class="text-blue-500">Privacy Policy</a></p>
