    ...
    return (
        ...
        <div className="hidden lg:flex lg:justify-between lg:items-center">
            ...
            <ul className="flex items-center space-x-4 text-sm font-semibold">
                ...
                <li><a href="/asdf" className="px-2 xl:px-4 py-2 text-gray-300 rounded-md hover:bg-gray-600">Account Settings</a></li>
                <li><a href="/asdf" className="px-2 xl:px-4 py-2 text-gray-300 rounded-md hover:bg-gray-600">Help Desk</a></li>
            </ul>
            <ul className="flex items-center gap-6">
                <li>
                    <a href="/asdf" className="text-sm font-sans text-gray-300 font-semibold tracking-wider">
                        {username}
                    </a>
                </li>
                <li>
